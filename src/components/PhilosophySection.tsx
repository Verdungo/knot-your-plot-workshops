...
const PhilosophySection = () => {
  return (
    <section id="philosophy" className="py-24 md:py-32 bg-gradient-warm">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p className="text-lg">
                In a world dominated by screens and endless notifications, we've forgotten
                the simple joy of creating something tangible with our hands.
              </p>
              <p className="text-lg">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-elevated">
              <img
                src={processImage}
                alt="The macramé process - hands creating beautiful knots"
            ...
            {/* Floating accent */}
            <motion.div
              className="absolute -bottom-6 -left-6 w-32 h-32 rounded-full bg-accent/10 blur-2xl"
              animate={{ scale: [1, 1.2, 1] }}
              transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
            />
            <motion.div
              className="absolute -top-6 -right-6 w-24 h-24 rounded-full bg-teal/10 blur-2xl"
