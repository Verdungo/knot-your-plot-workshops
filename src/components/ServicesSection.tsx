...
const services = [
  {
    ...
    location: "Portugal",
    description:
      "Fully-equipped sessions at your location. We bring everything—premium materials, tools, and the expertise to guide your team through a memorable experience.",
  ...
  },
  {
    ...
    description:
      "Live-streamed sessions with pre-shipped DIY kits. Perfect for remote teams looking to bond across borders.",
  ...
  },
  {
    ...
    description:
      "Premium gift boxes with video tutorials for self-paced creativity. An unforgettable wellness gift for your team.",
  ...
  },
  {
    ...
    description:
      "Finished macramé pieces tailored to your brand's color palette. Unique, handcrafted items that tell a story.",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-semibold text-foreground mb-6">
            Four ways to find your ground
          </h2>
          <p className="text-lg text-muted-foreground">
            Whether your team is in the same room or scattered across Europe,
            we have a format that fits your needs.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                key={service.title}
                className={`group relative bg-card rounded-2xl p-8 border-2 border-transparent transition-all duration-300 hover:shadow-elevated ${colors.border}`}
                ...
                <ul className="space-y-2 mb-8">
                  {service.features.map((feature) => (
                    <li key={feature} className="flex items-center text-sm text-muted-foreground">
                      <span className={`w-1.5 h-1.5 rounded-full ${colors.iconBg.replace('/10', '')} mr-3`} />
                      {feature}
                    </li>
                  ))}
                </ul>
