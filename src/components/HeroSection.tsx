    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pb-24">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          ...
          {/* Tagline */}
          <motion.p
            className="font-display text-lg md:text-xl text-muted-foreground mb-4 italic"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Helping corporate teams and communities reconnect with their physical selves
            through the meditative art of macramé.
          </motion.p>
