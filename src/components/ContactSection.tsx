...
const ContactSection = () => {
  const whatsappLink = "https://api.whatsapp.com/send/?phone=351913644619"; // Replace with actual number
  const telegramLink = "https://t.me/zhenyaryashko"; // Replace with actual username
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Whether you're planning a team building, looking for unique corporate gifts, or simply curious, we'd love
              to hear from you.
            </p>
          </motion.div>
          ...
          >
            ...
            <a
              ...
              className="group bg-card rounded-2xl p-8 shadow-soft hover:shadow-elevated transition-all duration-300 flex flex-col items-center text-center"
            >
              <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <MessageCircle className="w-8 h-8 text-primary" />
              </div>
              <h3 className="font-display text-xl font-semibold text-foreground mb-2">WhatsApp</h3>
              <p className="text-muted-foreground mb-4">Quick questions? Let's chat!</p>
            ...
            >
              ...
              <h3 className="font-display text-xl font-semibold text-foreground mb-2">Telegram</h3>
              <p className="text-muted-foreground mb-4">Prefer Telegram? I'm here too!</p>
              <Button variant="cta" size="lg">
                Message on Telegram
              </Button>
            </a>
